...
**Generated:** 44 concepts, 348 relationships from 24314 papers. Edges = co-occurrence (shared papers).

## Top concepts

| Concept | Kind | Papers |
|----------|------|--------|
| framework | curated | 7694 |
| Supervised Learning | taxonomy | 2618 |
| dataset | curated | 2277 |
| Diffusion | taxonomy | 2262 |
| survey | curated | 1850 |
| benchmark | curated | 1804 |
...
- framework — 804 shared paper(s)
- dataset — 213 shared paper(s)
- survey — 151 shared paper(s)
...
- framework — 360 shared paper(s)
- Transfer — 235 shared paper(s)
- taxonomy — 212 shared paper(s)
- Federated — 189 shared paper(s)
- Curriculum — 165 shared paper(s)
- Rlhf Alignment — 152 shared paper(s)
- Diffusion — 151 shared paper(s)
- quantitative — 136 shared paper(s)
...
- framework — 644 shared paper(s)
- dataset — 176 shared paper(s)
- benchmark — 156 shared paper(s)
- survey — 97 shared paper(s)
- experiment — 32 shared paper(s)
- quantitative — 26 shared paper(s)
- case study — 26 shared paper(s)
- reproducibility — 19 shared paper(s)

### Federated

- framework — 650 shared paper(s)
- survey — 189 shared paper(s)
- dataset — 168 shared paper(s)
- benchmark — 120 shared paper(s)
- taxonomy — 54 shared paper(s)
...
- framework — 535 shared paper(s)
- dataset — 176 shared paper(s)
- survey — 152 shared paper(s)
- benchmark — 119 shared paper(s)
- taxonomy — 36 shared paper(s)
...
- framework — 375 shared paper(s)
- survey — 235 shared paper(s)
- dataset — 217 shared paper(s)
- benchmark — 125 shared paper(s)
...
- framework — 465 shared paper(s)
- survey — 135 shared paper(s)
- benchmark — 115 shared paper(s)
- dataset — 104 shared paper(s)
- taxonomy — 29 shared paper(s)
...
- survey — 165 shared paper(s)
- dataset — 86 shared paper(s)
- quantitative — 83 shared paper(s)
- qualitative — 71 shared paper(s)
- benchmark — 70 shared paper(s)
...
- dataset — 117 shared paper(s)
- survey — 110 shared paper(s)
...
- survey — 129 shared paper(s)
- dataset — 105 shared paper(s)
- quantitative — 49 shared paper(s)
- benchmark — 47 shared paper(s)
...
- framework — 335 shared paper(s)
- benchmark — 82 shared paper(s)
...
- framework — 230 shared paper(s)
- survey — 123 shared paper(s)
- dataset — 92 shared paper(s)
- benchmark — 78 shared paper(s)
- qualitative — 12 shared paper(s)
- quantitative — 12 shared paper(s)
...
- framework — 164 shared paper(s)
- qualitative — 146 shared paper(s)
- survey — 136 shared paper(s)
- Curriculum — 83 shared paper(s)
...
- quantitative — 146 shared paper(s)
- framework — 127 shared paper(s)
- survey — 95 shared paper(s)
- Curriculum — 71 shared paper(s)
